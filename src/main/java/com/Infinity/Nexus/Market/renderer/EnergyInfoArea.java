package com.Infinity.Nexus.Market.renderer;
...
public class EnergyInfoArea {
    ...
    public List<Component> getTooltips() {
        return List.of(Component.translatable("gui.infinity_nexus_market.tooltip.energy", energy.getEnergyStored(), energy.getMaxEnergyStored()));
    }
    ...
    public void renderHorizontal(GuiGraphics guiGraphics) {
        int filledWidth = (int)(width * ((float)energy.getEnergyStored() / energy.getMaxEnergyStored()));
        guiGraphics.fillGradient(
                xPos,
                yPos,
                xPos + filledWidth,
